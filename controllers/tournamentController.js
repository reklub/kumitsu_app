...
exports.generateBrackets = async (req, res) => {
  try {
    ...
    // Get all categories for this tournament sorted for consistent ordering
    ...
    // Global match counter across all categories
    let globalMatchNumber = 1;
    ...
    for (const category of categories) {
      ...
      globalMatchNumber = result.nextMatchNumber;
    }
